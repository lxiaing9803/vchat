    ...
    <button class="vk-button
      ...
      cursor-pointer
       disabled:opacity-50 disabled:pointer-events-none" :class="[colorClasses, sizeClasses]"
        ...
        <Icon :icon="iconWithLoading" v-if="iconWithLoading" />
        <slot></slot>
    </button>
</template>
...
const colorVariants: Record<ButtonColor, any> = {
    'green': {
        plain: 'bg-green-50 text-green-700 hover:bg-green-700 border border-green-700 hover:text-white gap-2',
        normal: 'bg-green-700 text-white hover:bg-green-700/90 border border-green-700 gap-2'
    },
    'purple': {
        plain: 'bg-purple-50 text-purple-700 hover:bg-purple-700 border border-purple-700 hover:text-white gap-2',
        normal: 'bg-purple-700 text-white hover:bg-purple-700/90 border border-purple-700 gap-2'
    }
}
